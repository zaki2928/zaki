...
import {
  ...
  import {StockEditData} from '../../../store/Store';
...
class StockEdit extends Component {
  constructor(props) {
   ...
   componentDidMount(){
    console.log("calling stock edit rendering  ", StockEditData);
    ...
    console.log("calling edit ", StockEditData);
  
    if (StockEditData !== null) {
      this.setState(
        {
          data: StockEditData,
        },
        () => {
          ...
          this.setState({
            ...
            idPackaging: StockEditData.idPackaging, 
            description: StockEditData.description, 
            descriptionShort: StockEditData.descriptionShort, 
            typePackaging: StockEditData.typePackaging,
            calculVolume: StockEditData.calculVolume,
            emptyWeigth: StockEditData.emptyWeigth,
            lenthEXT: StockEditData.lenthEXT, 
            widthEXT: StockEditData.widthEXT, 
            heightEXT:StockEditData.heightEXT, 
            lenthINT: StockEditData.lenthINT, 
            widthINT: StockEditData.widthINT, 
            heightINT:StockEditData.heightINT, 
