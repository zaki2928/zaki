...
export default class GeneralNew extends Component {
  constructor(props) {
    super(props);
  ...
  //   if (GeneralNewData.length === 0) {
  //     console.log("length is zero");
  //     this.state.data.push(this.props.generalnewArr);
  //     console.log("after data pushed in table", this.state.data);
  //   } else {
  //     console.log("length is not zero", GeneralNewData);
  ...
  componentDidMount() {
    ...
    if (GeneralNewData.length === 0) {
      ...
      this.setState({
        data: GeneralNewData,
        // idPackaging: GeneralNewData[0].idPackaging, 
        // description: GeneralNewData[0].description, 

        // descriptionShort: GeneralNewData[0].descriptionShort, 
        // typePackaging: GeneralNewData[0].typePackaging,
        // calculVolume: GeneralNewData[0].calculVolume,
        // emptyWeigth: GeneralNewData[0].emptyWeigth,
        // lenthEXT: GeneralNewData[0].lenthEXT, 
        // widthEXT: GeneralNewData[0].widthEXT, 
        // heightEXT:GeneralNewData[0].heightEXT, 
        // lenthINT: GeneralNewData[0].lenthINT, 
        // widthINT: GeneralNewData[0].widthINT, 
        // heightINT:GeneralNewData[0].heightINT, 
      },
        () => {
  ...
  backHandler = () => {
    console.log("calling back handler for generalnew")
    remover("GeneralNew")
