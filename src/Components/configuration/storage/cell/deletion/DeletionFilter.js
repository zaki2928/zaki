...
import { DeletionData, ModificationHandler } from '../../../../../store/Store';
import axios  from "axios";
class DeletionFilter extends Component {
    constructor(props) {
        super(props);
      this.state = {
          locationList: false,
    ...
    render() {
        return (
            ...
            >
              {DeletionData.length !== 0 || this.state.locationList === true ? (
                <DeletionList backHandler={this.backHandler} data={this.state.data} />
              ) : (
                <div>
                  <span>
                    {" "}
