...
import { palletMovementEditData, remover, storagepalletid } from "../../../../store/Store";
export default class StoragePalletEdit extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ...
    console.log("calling edit ", palletMovementEditData);
    if(palletMovementEditData !== null){
      this.setState({
        ContainerNo: palletMovementEditData.containerNo,
        id_location: palletMovementEditData.id_location,
        status_container: palletMovementEditData.status_container,
        type_container: palletMovementEditData.type_container,
        id_container_father: palletMovementEditData.id_container_father,
        id_packaging: palletMovementEditData.id_packaging,
        weight: palletMovementEditData.weight,
        height: palletMovementEditData.height,
        volume: palletMovementEditData.volume,
        batch: palletMovementEditData.batch,
        status_mvt: palletMovementEditData.status_mvt,
      })
    }
    else{
      this.setState({
    ...
    // if (palletMovementEditData !== null) { 
    //   console.log("inside if condition--------------------",palletMovementEditData)
    //   this.setState(
    //     {
    //       data: palletMovementEditData,
    //     },
    //     () => {
  ...
  // componentDidMount = () => {
  //   console.log("com calling from palletedit", palletMovementEditData);
  //   if(palletMovementEditData !== null){
  //     this.setState(
  //       {
  //       data: palletMovementEditData
            ...
            <div>
              <span>
                ...
                <u>
                  ...
                  <b>
                    {" "}
                    <a style={{ cursor: "pointer" }} onClick={this.backHandler}>Pallet Movement List</a>
                  </b>
                </u>
                {" "}
                &#62;
